...
@dataclass
class InferenceAnimationProPipelineOutput(BaseOutput):
    r"""
...
class InferenceAnimationProPipeline(DiffusionPipeline):
    r"""
    ...
    def __call__(
        ...
        refine_reference_face_embeddings = refine_reference_face_embeddings.to(device=device, dtype=image_embeddings.dtype)
        ...
        with self.progress_bar(total=len(timesteps) * len(indices)) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if i > end_refine_step or i < start_refine_step:
                    latents = self.scheduler.step(
                        ...
                        **extra_step_kwargs,
                        ...
                        refine_face=False,
                        learning_rate=None,
                        num_optimization_iter=num_optimization_iter,
                        vae=None,
        ...
        return InferenceAnimationProPipelineOutput(frames=frames)
